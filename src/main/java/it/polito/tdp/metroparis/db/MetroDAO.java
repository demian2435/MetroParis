...
public class MetroDAO {
	...
	public List<Fermata> fermateConnesseFromStazione(Fermata fp, Map<Integer, Fermata> fermateIdMap) {
	...
	public List<CoppiaFermate> coppieFermate(Map<Integer, Fermata> fermateIdMap) {
		...
		try {
			...
			while (rs.next()) {
				result.add(new CoppiaFermate(fermateIdMap.get(rs.getInt("id_stazP")),
